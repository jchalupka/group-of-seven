...
class Result:
	def __init__(self, valid_parentheses, valid_arithmetic_expression):
		self.valid_parentheses = valid_parentheses
		self.valid_arithmetic_expression = valid_arithmetic_expression

	def valid(self):
		return self.valid_parentheses and self.valid_arithmetic_expression

	def result_message(self):
		if not self.valid():
			if not self.valid_parentheses:
...
def test(expression):
	#print expression
	valid = is_valid(expression).valid()
